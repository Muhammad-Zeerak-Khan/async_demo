"""
Demo for asyncronous way of downloading images from pexels.com
"""
import asyncio
import aiohttp
import time
...
async def download_file(session : aiohttp.ClientSession, photo_id : str, dirname: str) -> None:
    ...
    Args:
        ...
        dirname (str) : directory where the photos are to be downloaded
...
async def download_all(list_photo_ids: List[str], dirname : Optional[str]="images_02") -> None:
    ...
    Args:
        list_photo_id (List[str]): List of the photo id to download
        dirname (str, optional): directory where photos are to be downloaded. Defaults to "images_01" 
    """
